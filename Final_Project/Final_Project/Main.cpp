...
//window title
const char* const WINDOW_TITLE = "Module 6 Milestone: Thomas Bartlett";
...
// camera
Camera gCamera(glm::vec3(-12.0f, 8.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f), 10.0f, -30.0f);
...
glm::vec3 gSpotLightPosition(2.0f, 8.0f, -3.0f);
...
void main()
{
	...
	float keyStrength = 0.6f; // Set ambient or global lighting strength
...
void UProcessInput(GLFWwindow* window)
{
	...
	// Turn light off, green and white simulating the lamp (1, 2, 3)
...
void URender(vector<GLMesh> scene)
{
	...
	constexpr float angularVelocity = glm::radians(35.0f);
	if (gSpotLightOrbit)
	{
